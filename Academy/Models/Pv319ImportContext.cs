...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("server=DESKTOP-IIFDPU3\\SQLEXPRESS;Database=PV_319_IMPORT;Integrated Security=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Date).HasName("PK__DaysOFF__D9DE21FC7C96A476");
        ...
        modelBuilder.Entity<Group>(entity =>
        {
            ...
            entity.Property(e => e.Weekdats).HasColumnName("weekdats");
        ...
        {
            entity.HasKey(e => e.HolidayId).HasName("PK__Holidays__253884EAB58CE80E");

            entity.Property(e => e.HolidayId).HasColumnName("holiday_id");
            entity.Property(e => e.Day).HasColumnName("day");
            entity.Property(e => e.Diration).HasColumnName("diration");
        ...
        {
            entity.HasKey(e => e.PaumentId).HasName("PK__Salary__E9F730C4DC9074FD");

            entity.ToTable("Salary");

            entity.Property(e => e.PaumentId)
                .ValueGeneratedNever()
                .HasColumnName("paument_id");
